...
namespace INGA.Framework.Helpers.Configuration.ConfigurationElements
{
    public class CacheProviders: ConfigurationElement
    {
        ...
        public CacheProviders(string name, string host, int port, string username, string password, bool isActive,string cacheName)
        {
            Name = name;
            Host = host;
            Port = port;
        ...
        [ConfigurationProperty("CacheName", DefaultValue = "*", IsRequired = false, IsKey = false)]
